...
%define (S,t) grid for the vol surface - defines where theta lives 
S_vol_grid = linspace(0.5*S0, 1.5*S0,5); %5 stock price points (DEFINES THE ATM at parameter 13!
t_vol_grid = [0, 0.25, 0.5, 1.0, 1.5, 2.0]; %6 time points
...
Sigma_true(1, :) = 0.20;   % t=0 row: set to flat baseline

theta_true = Sigma_true(:); %what we want to infer
